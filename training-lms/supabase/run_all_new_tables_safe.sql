-- =====================================================
-- SAFE VERSION - Won't error on existing objects
-- Copy and paste this entire file into Supabase SQL Editor
-- =====================================================

-- =====================================================
-- 1. TRAINEE REFLECTIONS TABLE (skip if exists)
-- =====================================================
...
DROP POLICY IF EXISTS "Trainees can insert own reflections" ON trainee_reflections;
DROP POLICY IF EXISTS "Allow read on trainee_reflections" ON trainee_reflections;
...
DROP POLICY IF EXISTS "Trainees can insert own performance" ON activity_performance;
DROP POLICY IF EXISTS "Allow read on activity_performance" ON activity_performance;
...
-- DONE!
-- =====================================================
SELECT 'SUCCESS: All tables ready!' as status;
