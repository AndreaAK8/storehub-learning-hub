      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        ...
        {traineesWithPending.length > 0 ? (
          ...
          <div className="p-12 text-center">
            <svg className="w-12 h-12 mx-auto text-[#2a6ee8]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <p className="mt-4 text-[#55504a]">All trainees are up to date with their assessments!</p>
          </div>
        )}
      </div>
