...
export default function MyScoresPage() {
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <h2 className="text-xl font-bold text-[#2f2922] mb-2">Unable to Load Scores</h2>
          <p className="text-[#7a7672] mb-4">{error}</p>
          <button
            onClick={fetchData}
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-[#2f2922]">My Scores</h1>
        <p className="text-[#7a7672] mt-1">Track your training performance and progress</p>
      </div>
